...
!!! essential "Useful follow-up prompts"
    1. "What alternative renderings are possible for [a specific phrase]?" — A good response will note the semantic range of key terms and identify where interpretive choices carry scholarly stakes.
    2. "How does the word order or syntax create rhetorical emphasis in this passage?" — This probes whether the model can move beyond lexical translation into stylistic analysis.
    3. "What is the relationship between this passage and the broader argument of the work?" — Here the model must connect a specific passage to the work's larger aims.
