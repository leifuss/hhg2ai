...
!!! leifnote "Leif's Notes"
    **Deep Research is a scoping assistant, not a scholarly guarantor.** The reports look polished and well-sourced. That is precisely when you need to check the references most carefully. See [Verification & Citation](../essentials/verification.md).
