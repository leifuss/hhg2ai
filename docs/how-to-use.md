...
description: "An overview of the guide's structure, suggested reading paths, and conventions."
---
...
**[Essentials](essentials/index.md)** covers the practices that apply regardless of which platform you use: verification, prompting, data governance, disclosure, and cost awareness. Skim these before doing serious work. Return to them when something goes wrong.

**[Field Guides](field-guides/index.md)** are organised by scholarly activity — translation, close reading, archival research, spatial analysis, and so on. Each guide covers where AI tools help, where they mislead, and what to watch out for. Start from your discipline's [pathway page](field-guides/index.md) to find the most relevant activities.
...
Start with the [Primer](guide/index.md). Then try a free tier of any platform — the [Platform Guides](platforms/index.md) landing page can help you choose. Come back to the [Essentials](essentials/index.md) before using AI output in your work.

**"I have used ChatGPT / Claude / Gemini casually and want to use it better."**
Read the [Essentials](essentials/index.md), especially [Verification](essentials/verification.md) and [Prompting](essentials/prompting.md). Then find your task in the [Field Guides](field-guides/index.md).
