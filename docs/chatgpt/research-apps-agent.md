...
!!! leifnote "Leif's Notes"
    **Deep research is a research assistant for scoping; used badly, it becomes a polished source of false confidence.** The reports look authoritative. That is precisely when you need to check the sources most carefully. See [Verification & Citation](../essentials/verification.md) for how to do this systematically.
...
1. Use **ordinary chat** first.
2. Use **deep research** when you need broad web-based synthesis.
3. Use **apps** when you need access to your own tools or repositories.
4. Use **agent mode** only when the task truly requires action as well as analysis.
