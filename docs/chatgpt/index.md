...
!!! panic "Don't Panic"
    **Skip to what you need:** If you only use ChatGPT's conversational interface, read the orientation below and [Chat](chat.md), then skip to the [Essentials](../essentials/index.md) section. If you want ChatGPT to do structured web research, see [Research, Apps & Agent](research-apps-agent.md). If you are doing genuine coding work, see [GPTs & Codex](gpts-codex.md).
...
[Read about Projects &rarr;](projects.md)
...
[Read about Deep Research &rarr;](research-apps-agent.md)
...
[Read about Apps & Agent &rarr;](research-apps-agent.md#apps)
...
[Read about Canvas &rarr;](canvas-data-study.md)
...
[Read about GPTs &rarr;](gpts-codex.md)
...
[Read about Codex &rarr;](gpts-codex.md#codex)
...
|---|---|---|
| **Do you need structured web research?** | &darr; | [Deep Research](research-apps-agent.md) |
| **Is the work ongoing across sessions?** | &darr; | [Projects](projects.md) |
| **Do you repeat the same kind of task often?** | &darr; | [Custom GPTs](gpts-codex.md) |
| **Are you building software?** | [Chat](chat.md) | [Codex](gpts-codex.md#codex) |

*Which ChatGPT tool do I use? A quick decision guide.*

!!! essential "Essential"
    **If you mainly read, write, teach, and analyse texts:** Start with [Chat](chat.md). Use Projects for sustained work. You can safely ignore Codex, agent mode, and custom GPTs until you have a specific need. The cross-platform essentials still apply to you — see [Essentials](../essentials/index.md).

    **If you want to build tools, transform data, or automate processing:** Consider [Codex](gpts-codex.md#codex) or the [OpenAI API](https://platform.openai.com/). The [Essentials](../essentials/index.md) still apply.
...
- [Chat](chat.md) — Conversations, web search, uploads, and writing assistance
- [Projects](projects.md) — Memory, longer-running work, and persistent context
- [Research, Apps & Agent](research-apps-agent.md) — Deep research, connected apps, and agentic work
- [Canvas, Data & Study](canvas-data-study.md) — Editing surface, data analysis, study mode, and voice
- [GPTs & Codex](gpts-codex.md) — Custom configurations and coding
