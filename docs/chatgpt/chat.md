...
!!! leifnote "Leif's Notes"
    **Treat ChatGPT as a fast, suggestive assistant — never as an authority.** It will hallucinate references, flatten nuance, and sound confident when it shouldn't. Always verify factual claims before reusing them in teaching or publication. See [Verification & Citation](../essentials/verification.md) for a systematic approach.
