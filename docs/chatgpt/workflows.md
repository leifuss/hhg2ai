...
These workflows show how to use ChatGPT's tools for common humanities tasks. Each suggests a starting point and the right tool for the job. For verification practices that apply across all platforms, see [Verification & Citation](../essentials/verification.md).
