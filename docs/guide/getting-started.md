...
| Platform | URL | Notes |
|----------|-----|-------|
| **Claude** | [claude.ai](https://claude.ai) | Recommended. Strong for analysis and writing. |
| **ChatGPT** | [chatgpt.com](https://chatgpt.com) | Widely used. Good all-round. |
| **Gemini** | [gemini.google.com](https://gemini.google.com) | Google's offering. Good for web-connected tasks. |
...
For a full treatment of prompting strategy, see [Prompting Principles](../essentials/prompting.md) in Essentials.
...
- **[Claude](../claude/index.md)** or another platform manual — if you've decided which tool to use
