...
This page is about *how to think*, not what to do. The practical guidance is elsewhere — [Use Cases](use-cases.md) for tasks, [Essentials](../essentials/index.md) for principles, platform manuals for specific tools. This page addresses the prior question: what kind of thing are you dealing with, and what mental model serves you best?
...
For a detailed framework on verification practices, see [Verification & Citation](../essentials/verification.md) in Essentials.
...
- **When it involves sensitive data.** See [Data Governance](../essentials/data-governance.md) before uploading anything confidential.
...
*For practical tasks to try, see [Use Cases](use-cases.md). For verification practices, see [Essentials](../essentials/index.md).*
