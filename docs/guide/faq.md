...
- **In assessment:** This is an institutional and pedagogical question, not a moral one. See [Disclosure & Ethics](../essentials/disclosure.md) for practical guidance.
...
**The practical response:** Build verification into every workflow. See [Verification & Citation](../essentials/verification.md) for a detailed framework. The short version: never trust a citation you haven't checked, never trust a factual claim you haven't verified, and be especially sceptical of output that sounds authoritative.
...
See [Data Governance](../essentials/data-governance.md) for the full picture.
...
!!! leifnote "Leif's Notes"
    I was sceptical too, and I think scepticism remains warranted. But the difference between Claude 3 in early 2024 and Claude 4 in 2026 is not incremental — it's qualitative. If you tried these tools and found them wanting, I'd suggest a 15-minute retest with the [Getting Started](getting-started.md) exercise. If they're still not useful for your work, that's a perfectly defensible conclusion.

## Can AI understand my field?

No. LLMs do not understand anything. They generate statistically probable text based on patterns in training data. For well-documented fields and mainstream topics, this pattern-matching can produce surprisingly useful output. For specialist, niche, or cutting-edge topics, the output becomes less reliable.
...
- **Ready for a specific platform?** Try the [Claude manual](../claude/index.md)
