...
*For practical use cases, see [Use Cases](use-cases.md). For a 15-minute hands-on exercise, see [Getting Started](getting-started.md). For cross-platform verification and data governance, see [Essentials](../essentials/index.md).*
