...
!!! essential "Essential"
    At minimum, read **[Verification & Citation](verification.md)** and **[Data Governance](data-governance.md)** before using any AI tool for academic work. Everything else here is important, but those two pages address the issues most likely to cause real problems.
...
|------|----------------|------|
| **[Verification & Citation](verification.md)** | What LLMs get wrong, how to check their outputs, the verification ladder, recording provenance | 10 min |
| **[Data Governance](data-governance.md)** | What providers do with your data, institutional policies, practical guidelines by data type | 8 min |
| **[Prompting Principles](prompting.md)** | Being specific, providing context, role-framing, structured prompts, iteration | 10 min |
| **[Disclosure & Ethics](disclosure.md)** | When and how to declare AI use in teaching and publication, transparency templates | 8 min |
| **[Multi-Model Strategy](multi-model.md)** | Using disagreement as a signal, mixing models within and across providers | 6 min |
| **[Cost & Plans](cost.md)** | Subscription tiers, API pricing, cost-saving strategies, what is worth paying for | 8 min |
| **[Decision Sheet](decision-sheet.md)** | A one-page printable checklist: before, during, and after using AI | 3 min |
...
**If you are brand new to AI:** Read [Verification & Citation](verification.md) and [Data Governance](data-governance.md) first. Then read [Prompting Principles](prompting.md) before your first serious session. The rest can wait until you need it.

**If you are already experimenting:** Skim the [Decision Sheet](decision-sheet.md) to check whether you have blind spots, then read any pages that cover areas you have not thought about.

**If you are setting policy:** [Disclosure & Ethics](disclosure.md) and [Data Governance](data-governance.md) are the most relevant. The [Decision Sheet](decision-sheet.md) can be adapted for departmental guidance documents.

**If you want a quick reference:** The [Decision Sheet](decision-sheet.md) distils everything on these pages into a single-page checklist. It is designed to be printed or kept open during a session.
...
1. **Check your data before uploading.** Not everything belongs on a commercial server. Five seconds of thought can prevent a governance problem. ([Data Governance](data-governance.md))

2. **Verify outputs before using them.** LLMs are confident, not reliable. Every citation, every factual claim, every translation needs checking at a level proportionate to the stakes. ([Verification & Citation](verification.md))

3. **Disclose your AI use.** Transparency about methods is a scholarly norm, not a confession of weakness. If AI played a role in the work, say so. ([Disclosure & Ethics](disclosure.md))
